...
BOOL CCommand_DisbandGroupCommand(char const* cmd, char const* args);
BOOL CCommand_CharRenameCommand(char const* cmd, char const* args);
BOOL CCommand_BattlemasterHelloCommand(char const* cmd, char const* args);
BOOL CCommand_RaidReadyCheckCommand(char const* cmd, char const* args);
...
BOOL CCommand_AbuseCharCreateDelCommand(char const* cmd, char const* args);
BOOL CCommand_CreateCharCommand(char const* cmd, char const* args);
BOOL CCommand_SetChannelOwnerCommand(char const* cmd, char const* args);
BOOL CCommand_SetChannelModeratorCommand(char const* cmd, char const* args);
BOOL CCommand_CharLoginCommand(char const* cmd, char const* args);
BOOL CCommand_WarpCommand(char const* cmd, char const* args);
BOOL CCommand_SetChannelUnmoderatorCommand(char const* cmd, char const* args);
BOOL CCommand_SetChannelPasswordCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelMuteCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelUnmuteCommand(char const* cmd, char const* args);
//BOOL CCommand_ChannelInviteCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelKickCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelBanCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelUnbanCommand(char const* cmd, char const* args);
BOOL CCommand_ChannelAnnounceCommand(char const* cmd, char const* args);
BOOL CCommand_HonorInspectCommand(char const* cmd, char const* args);
BOOL CCommand_StoreGuidCommand(char const* cmd, char const* args);
BOOL CCommand_GetGuidFromStoreCommand(char const* cmd, char const* args);
BOOL CCommand_SendWhisperToCommand(char const* cmd, char const* args);
BOOL CCommand_CastCommand(char const* cmd, char const* args);
BOOL CCommand_PalaMassDamageCommand(char const* cmd, char const* args);
...
BOOL CCommand_SendZoneUpdateCommand(char const* cmd, char const* args);
...
BOOL CCommand_CreatureQueryCommand(char const* cmd, char const* args);
BOOL CCommand_FloodTry(char const* cmd, char const* args);
BOOL CCommand_ReadyCheckConfirmNearby(char const* cmd, char const* args);
BOOL CCommand_CompleteQuest(char const* cmd, char const* args);
BOOL CCommand_PingMinimap(char const* cmd, char const* args);
